<template>
  <div>
    <div style="font-weight:1000;font-size:20px">待审核</div>
      ...
      <div style="width:80%;">
        ...
        >
          ...
          <tr v-for="taskData in taskArray.task" :key="taskData.taskName">
            ...
            <td>
              <van-tag type="danger" size="large">审核中</van-tag>
              <van-button style="margin:10px 0" type="info" size="small" @click="$router.push('/home/auditDetail')">审核</van-button>
            </td>
          </tr>
        </div>
      </div>
    </div>
    <h1 style="font-weight:1000;font-size:20px;color:green">已审核</h1>
