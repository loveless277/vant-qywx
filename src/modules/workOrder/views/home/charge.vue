      ...
      <div style="width:80%;">
        ...
        >
          ...
          <tr v-for="taskData in taskArray.task" :key="taskData.taskName">
            ...
            <td>
                <van-tag type="danger" size="large">分配人</van-tag>
              <van-button type="info" style="margin:10px 0" size="small" @click="$router.push('/home/chargeDetail')">查看</van-button>
              <van-button type="info" size="small" @click="complete()">确认完成</van-button>
            </td>
          </tr>
        </div>
      </div>
        ...
        <div style="width:80%;">
          ...
          >
            ...
            <tr v-for="taskData in taskArray.task" :key="taskData.taskName">
              ...
              <td>
                <van-tag type="sucess" size="large">已完成</van-tag>
